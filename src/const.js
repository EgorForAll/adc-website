...
export const catalogList = [
  ...
  },
  {
    ...
    description: 'Проведение технического осмотра транспортного средства в соответствии с федеральным законом 170-ФЗ "О техническом осмотре трансопртных средств".',
    image: auto
  }
];
